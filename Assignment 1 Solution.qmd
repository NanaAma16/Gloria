...
subtitle: |
  ...
  | Winter 2024
  | Assignment 1
author: "Gloria Nana Ama Boadi  (202287981)"
...
1.  Create a personal Quarto website hosted on GitHup pages. For this question, you only have to write the link to your page. Please see the video tutorial entitled "Create_Quarto_Website" posted on Nexus. For reference, you can check out my GitHub repository at <https://github.com/clairl/clairl.github.io> (be sure to check out the "\_quarto.yml" file for help with the navigation bar). Your website should include the following:
    ...
    ii) A Curriculum Vitae page
        -   You may choose to upload a file or write your info on the page.
    iii) Contact Information
    iv) Navigation bar with "Home", "CV", and "Contact" Buttons. The navigation bar is edited in the "\_quarto.yml" file.
